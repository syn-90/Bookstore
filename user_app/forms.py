...
class RegisterForm(forms.Form):
    ...
    phone_number = forms.CharField(widget=forms.TextInput(attrs={
        'type': "number", 'class': "form-control", 'placeholder': "شماره تماس", 'required': "required",
        'name': "phone_number"}),
        error_messages={
            'required': "شماره تماس اجباری میباشد"
        })
    password = forms.CharField(max_length=50, min_length=5, widget=forms.PasswordInput(attrs={
        'type': "password", 'class': "form-control", 'id': "toggle_passowrd_field", 'placeholder': "رمز",
    ...
    confirm_password = forms.CharField(widget=forms.PasswordInput(attrs={
        'type': "password", 'class': "form-control", 'id': "toggle_passowrd_field02", 'placeholder': "تکرار رمز",
